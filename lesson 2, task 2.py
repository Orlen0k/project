...
for part in first_list:
    if part.isdigit():
        second_list.extend(['"', f'{int(part):02}', '"'])
    elif part.startswith('+') or part.startswith('-') and part[1:].isdigit():
        second_list.extend(['"', f'{part[0]}{int(part[1:]):02}', '"'])
    else:
        second_list.append(part)
